...
let boxesTotalElement = document.getElementById("boxes-total");
let boxesBackgroundElement = document.getElementById("boxes-background");

function createBoxes() {
  /* Number of boxes to display */
  let boxesTotal = boxesTotalElement.value;
  let boxesBackgroundColor = boxesBackgroundElement.value;

  /* If we didn't specify any color, let's use a default one */
  if (boxesBackgroundColor === "") {
    boxesBackgroundColor = "limegreen";
  }
  ...
  while (counter < boxesTotal) {
    ...
    box.style.backgroundColor = boxesBackgroundColor;
